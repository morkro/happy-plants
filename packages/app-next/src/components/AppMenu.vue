<template>
  <div id="app-menu">
    <router-link to="/home" class="menu-link link-home">
      <svg width="24px" height="26px" viewBox="0 0 24 26" xmlns="http://www.w3.org/2000/svg">
        ...
        >
          <g transform="translate(1.000000, 1.000000)" stroke="#0A3E2B" stroke-width="2">
            <path
              ...
              id="Path"
            ></path>
            <polyline id="Path" points="7.2 24 7.2 12 14.4 12 14.4 24"></polyline>
          </g>
        </g>
      </svg>
      <span class="visuallyhidden">Home</span>
    </router-link>
    <router-link to="/watering" class="menu-link link-watering">
      ...
      <span class="visuallyhidden">Watering</span>
    </router-link>
    <router-link to="/new" class="menu-link link-add-new">
      <svg width="26px" height="26px" viewBox="0 0 26 26" xmlns="http://www.w3.org/2000/svg">
        ...
        >
          ...
          <line x1="12" y1="6.66666667" x2="12" y2="17.3333333"></line>
          <line x1="6.66666667" y1="12" x2="17.3333333" y2="12"></line>
        </g>
      </svg>
      <span class="visuallyhidden">Add new</span>
    </router-link>
    <router-link to="/settings" class="menu-link link-settings">
      <svg
        width="26px"
        height="26px"
        viewBox="0 0 26 26"

<template>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 33 30" id="app-logo">
    <g v-if="color === 'green'" fill="none" fill-rule="evenodd">
      <path
    ...
    <g v-else fill="none" fill-rule="evenodd" stroke="var(--brand-white)">
      <path

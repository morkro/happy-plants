<template>
  <v-layout class="screen-settings-bugreport">
    <app-header return-to="/settings" color="white">
      Bug report
      <template #actions>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 104 86"
          class="screen-settings-header-illustration"
        >
    ...
    <main>
      <form @submit.prevent="submitBugReport">
        <label-group
          ...
          label="Please describe the bug you're facing."
          color="green"
        >
...
<style lang="postcss">
  .screen-settings-bugreport #app-header {
    background: var(--brand-green);

    & .screen-settings-header-illustration {
      width: 104px;
      display: block;
      position: absolute;
      right: 0;
  ...
  .screen-settings-bugreport .bugreport-header {
    width: 100%;
  ...
  .screen-settings-bugreport main {
